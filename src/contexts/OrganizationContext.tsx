...
const DEFAULT_BRANDING: OrganizationBranding = {
  organizationName: 'Lessa Mahallu Management',
  organizationNameMalayalam: 'മഹല്ല് പോർട്ടൽ',
  shortName: 'LMM',
  logoUrl: null,
  faviconUrl: null,
  primaryColor: '#00966b',
  ...
  accentColor: '#10b981',
  contactEmail: 'contact@mahal.org',
  phone: '+91 98765 43210',
  website: 'https://mahal.org',
  address: 'Mahallu Central Juma Masjid, Wayanad, Kerala',
  registrationNumber: 'MHL-2026-REG-88',
